-- Function: unit_tests_security.signatures_teacher(boolean)

-- DROP FUNCTION unit_tests_security.signatures_teacher(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.signatures_teacher(
...
BEGIN
  ...
  -------------------------------------------------
  BEGIN
    SET ROLE 'test-teacher-d@scuola-1.it';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.signatures_teacher(boolean)
  OWNER TO postgres;
