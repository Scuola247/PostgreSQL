-- Function: unit_tests_security.signatures_student(boolean)

-- DROP FUNCTION unit_tests_security.signatures_student(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.signatures_student(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.signatures_student(boolean)
  OWNER TO postgres;
