-- Function: unit_tests_security.teachers_notes_supervisor(boolean)

-- DROP FUNCTION unit_tests_security.teachers_notes_supervisor(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.teachers_notes_supervisor(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.teachers_notes_supervisor(boolean)
  OWNER TO postgres;
