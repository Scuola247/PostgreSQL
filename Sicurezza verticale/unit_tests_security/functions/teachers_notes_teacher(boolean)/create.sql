-- Function: unit_tests_security.teachers_notes_teacher(boolean)

-- DROP FUNCTION unit_tests_security.teachers_notes_teacher(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.teachers_notes_teacher(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.teachers_notes_teacher(boolean)
  OWNER TO postgres;
