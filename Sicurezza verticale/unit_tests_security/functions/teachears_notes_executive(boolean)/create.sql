-- Function: unit_tests_security.teachers_notes_executive(boolean)

-- DROP FUNCTION unit_tests_security.teachers_notes_executive(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.teachers_notes_executive(
...
BEGIN
  ...
  -------------------------------------------------
  test_name = 'INSERT teachers_notes with no permission';
  -------------------------------------------------
  BEGIN
    SET ROLE 'test-executive-d@scuola-1.it';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.teachers_notes_executive(boolean)
  OWNER TO postgres;
