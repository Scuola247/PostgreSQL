-- Function: unit_tests_security.signatures_executive(boolean)

-- DROP FUNCTION unit_tests_security.signatures_executive(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.signatures_executive(
...
BEGIN
  ...
  -------------------------------------------------
  BEGIN
    SET ROLE 'test-executive-d@scuola-1.it';
  ...
  BEGIN
    SET ROLE 'test-executive-d@scuola-1.it';
    INSERT INTO public.signatures(signature,classroom,teacher,on_date,at_time) VALUES ('10033773000000000','10035000000000','32936000000000','2013-09-19','09:47:57');
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.signatures_executive(boolean)
  OWNER TO postgres;
