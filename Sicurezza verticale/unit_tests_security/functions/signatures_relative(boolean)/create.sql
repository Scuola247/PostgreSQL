-- Function: unit_tests_security.signatures_relative(boolean)

-- DROP FUNCTION unit_tests_security.signatures_relative(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.signatures_relative(
...
BEGIN
  ...
  -------------------------------------------------
  BEGIN
    SET ROLE 'test-relative-d@scuola-1.it';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.signatures_relative(boolean)
  OWNER TO postgres;
