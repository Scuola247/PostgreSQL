-- Function: public.tr_communications_media_iu()

-- DROP FUNCTION public.tr_communications_media_iu();

CREATE OR REPLACE FUNCTION public.tr_communications_media_iu()
  RETURNS trigger AS
$BODY$
<<me>>
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.tr_communications_media_iu()
  OWNER TO postgres;
GRANT EXECUTE ON FUNCTION public.tr_communications_media_iu() TO postgres;
GRANT EXECUTE ON FUNCTION public.tr_communications_media_iu() TO scuola247_relative;
REVOKE ALL ON FUNCTION public.tr_communications_media_iu() FROM public;
