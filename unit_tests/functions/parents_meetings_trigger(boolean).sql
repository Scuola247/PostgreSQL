-- Function: unit_tests.parents_meetings_trigger(boolean)

-- DROP FUNCTION unit_tests.parents_meetings_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests.parents_meetings_trigger(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.parents_meetings_trigger(boolean)
  OWNER TO postgres;
