-- Function: unit_tests.parents_meetings(boolean)

-- DROP FUNCTION unit_tests.parents_meetings(boolean);

CREATE OR REPLACE FUNCTION unit_tests.parents_meetings(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.parents_meetings(boolean)
  OWNER TO postgres;
