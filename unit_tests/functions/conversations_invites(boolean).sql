-- Function: unit_tests.conversations_invites(boolean)

-- DROP FUNCTION unit_tests.conversations_invites(boolean);

CREATE OR REPLACE FUNCTION unit_tests.conversations_invites(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.conversations_invites(boolean)
  OWNER TO postgres;
