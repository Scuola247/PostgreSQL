-- Function: unit_tests.valutations_qualifications_check(boolean)

-- DROP FUNCTION unit_tests.valutations_qualifications_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.valutations_qualifications_check(
...
BEGIN
  ...
  BEGIN
    ...
    EXCEPTION WHEN SQLSTATE '23505' THEN 
      ...
      IF error.constraint_name = 'valutations_qualificationtions_uq_qualification' THEN
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.valutations_qualifications_check(boolean)
  OWNER TO postgres;
