-- Function: unit_tests.grade_types(boolean)

-- DROP FUNCTION unit_tests.grade_types(boolean);

CREATE OR REPLACE FUNCTION unit_tests.grade_types(
...
BEGIN
  ...
  IF _build_dependencies THEN
    PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'subjects');
    RETURN;
  END IF;  
  ---------------------------------
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.grade_types(boolean)
  OWNER TO postgres;
