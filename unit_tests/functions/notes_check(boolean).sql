-- Function: unit_tests.notes_check(boolean)

-- DROP FUNCTION unit_tests.notes_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.notes_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.notes_check(boolean)
  OWNER TO postgres;
