-- Function: unit_tests.absences_check(boolean)

-- DROP FUNCTION unit_tests.absences_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.absences_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.absences_check(boolean)
  OWNER TO postgres;
