-- Function: unit_tests.faults_check(boolean)

-- DROP FUNCTION unit_tests.faults_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.faults_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.faults_check(boolean)
  OWNER TO postgres;
