-- Function: unit_tests.classrooms(boolean)

-- DROP FUNCTION unit_tests.classrooms(boolean);

CREATE OR REPLACE FUNCTION unit_tests.classrooms(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.classrooms(boolean)
  OWNER TO postgres;
