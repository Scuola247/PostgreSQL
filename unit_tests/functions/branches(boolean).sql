-- Function: unit_tests.branches(boolean)

-- DROP FUNCTION unit_tests.branches(boolean);

CREATE OR REPLACE FUNCTION unit_tests.branches(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.branches(boolean)
  OWNER TO postgres;
