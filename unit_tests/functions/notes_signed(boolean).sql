-- Function: unit_tests.notes_signed(boolean)

-- DROP FUNCTION unit_tests.notes_signed(boolean);

CREATE OR REPLACE FUNCTION unit_tests.notes_signed(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.notes_signed(boolean)
  OWNER TO postgres;
