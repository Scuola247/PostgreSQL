...
--
-- TOC entry 1715 (class 1247 OID 759688)
...
--
-- TOC entry 538 (class 1255 OID 19379)
...
--
-- TOC entry 539 (class 1255 OID 19380)
...
--
-- TOC entry 2662 (class 2617 OID 759710)
...
--
-- TOC entry 331 (class 1259 OID 19930)
-- Name: ip_addresses; Type: TABLE; Schema: utility; Owner: postgres
--
...
-- Dependencies: 331
-- Name: TABLE ip_addresses; Type: COMMENT; Schema: utility; Owner: postgres
--
...
--
-- TOC entry 332 (class 1259 OID 19937)
-- Name: apache2_conf; Type: VIEW; Schema: utility; Owner: postgres
--
...
-- Dependencies: 332
-- Name: VIEW apache2_conf; Type: COMMENT; Schema: utility; Owner: postgres
--
...
--
-- TOC entry 333 (class 1259 OID 19941)
...
--
-- TOC entry 334 (class 1259 OID 19948)
...
--
-- TOC entry 335 (class 1259 OID 19953)
-- Name: ip_addresses_country_list; Type: VIEW; Schema: utility; Owner: postgres
--
...
--
-- TOC entry 336 (class 1259 OID 19957)
...
--
-- TOC entry 337 (class 1259 OID 19959)
...
--
-- TOC entry 338 (class 1259 OID 19964)
-- Name: usenames_ex; Type: TABLE; Schema: utility; Owner: postgres
--
...
-- Dependencies: 338
-- Name: TABLE usenames_ex; Type: COMMENT; Schema: utility; Owner: postgres
--

COMMENT ON TABLE usenames_ex IS 'add informations to usename''s system table';


--
-- TOC entry 3745 (class 0 OID 0)
-- Dependencies: 338
-- Name: COLUMN usenames_ex.token; Type: COMMENT; Schema: utility; Owner: postgres
--
...
--
-- TOC entry 3432 (class 2606 OID 138707)
...
--
-- TOC entry 3434 (class 2606 OID 138709)
...
--
-- TOC entry 3430 (class 2606 OID 138711)
-- Name: ip_addresses ip_addresses_pkey; Type: CONSTRAINT; Schema: utility; Owner: postgres
--

ALTER TABLE ONLY ip_addresses
    ADD CONSTRAINT ip_addresses_pkey PRIMARY KEY (ip_address);


--
-- TOC entry 3436 (class 2606 OID 138713)
-- Name: usenames_ex usenames_ex_pk; Type: CONSTRAINT; Schema: utility; Owner: postgres
--
...
--
-- TOC entry 3437 (class 2620 OID 138855)
-- Name: usenames_ex usenames_ex_iu; Type: TRIGGER; Schema: utility; Owner: postgres
--

CREATE TRIGGER usenames_ex_iu AFTER INSERT OR UPDATE ON usenames_ex FOR EACH ROW EXECUTE PROCEDURE tr_usenames_ex_iu();
