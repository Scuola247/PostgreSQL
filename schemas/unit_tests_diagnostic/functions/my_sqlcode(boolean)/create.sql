...
BEGIN
  ...
  BEGIN
    ...
    */
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.communication_types(boolean)',diagnostic.my_sqlcode('unit_tests_public.communication_types(boolean)','0'),'U06Y0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.communications_media(boolean)',diagnostic.my_sqlcode('unit_tests_public.communications_media(boolean)','0'),'U06W0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.absences(boolean)',diagnostic.my_sqlcode('unit_tests_public.absences(boolean)','0'),'U06M0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.classrooms(boolean)',diagnostic.my_sqlcode('unit_tests_public.classrooms(boolean)','0'),'U06S0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.classrooms_students(boolean)',diagnostic.my_sqlcode('unit_tests_public.classrooms_students(boolean)','0'),'U06T0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.countries(boolean)',diagnostic.my_sqlcode('unit_tests_public.countries(boolean)','0'),'U0710');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.cities(boolean)',diagnostic.my_sqlcode('unit_tests_public.cities(boolean)','0'),'U06R0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grades(boolean)',diagnostic.my_sqlcode('unit_tests_public.grades(boolean)','0'),'U07A0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.districts(boolean)',diagnostic.my_sqlcode('unit_tests_public.districts(boolean)','0'),'U0750');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.delays(boolean)',diagnostic.my_sqlcode('unit_tests_public.delays(boolean)','0'),'U0730');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.faults(boolean)',diagnostic.my_sqlcode('unit_tests_public.faults(boolean)','0'),'U0780');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.explanations(boolean)',diagnostic.my_sqlcode('unit_tests_public.explanations(boolean)','0'),'U0760');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grade_types(boolean)',diagnostic.my_sqlcode('unit_tests_public.grade_types(boolean)','0'),'U07B0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grading_meetings_valutations(boolean)',diagnostic.my_sqlcode('unit_tests_public.grading_meetings_valutations(boolean)','0'),'U07F0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grading_meetings_valutations_qua(boolean)',diagnostic.my_sqlcode('unit_tests_public.grading_meetings_valutations_qua(boolean)','0'),'U07G0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.notes(boolean)',diagnostic.my_sqlcode('unit_tests_public.notes(boolean)','0'),'U07T0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.lessons(boolean)',diagnostic.my_sqlcode('unit_tests_public.lessons(boolean)','0'),'U07M0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.metrics(boolean)',diagnostic.my_sqlcode('unit_tests_public.metrics(boolean)','0'),'U07Q0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.messages(boolean)',diagnostic.my_sqlcode('unit_tests_public.messages(boolean)','0'),'U07N0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.messages_read(boolean)',diagnostic.my_sqlcode('unit_tests_public.messages_read(boolean)','0'),'U07P0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.out_of_classrooms(boolean)',diagnostic.my_sqlcode('unit_tests_public.out_of_classrooms(boolean)','0'),'U07V0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.persons_addresses(boolean)',diagnostic.my_sqlcode('unit_tests_public.persons_addresses(boolean)','0'),'U07X0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.persons_relations(boolean)',diagnostic.my_sqlcode('unit_tests_public.persons_relations(boolean)','0'),'U07Z0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.regions(boolean)',diagnostic.my_sqlcode('unit_tests_public.regions(boolean)','0'),'U0820');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.school_years(boolean)',diagnostic.my_sqlcode('unit_tests_public.school_years(boolean)','0'),'U0880');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.parents_meetings(boolean)',diagnostic.my_sqlcode('unit_tests_public.parents_meetings(boolean)','0'),'U07W0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.persons_roles(boolean)',diagnostic.my_sqlcode('unit_tests_public.persons_roles(boolean)','0'),'U0800');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.subjects(boolean)',diagnostic.my_sqlcode('unit_tests_public.subjects(boolean)','0'),'U0890');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.topics(boolean)',diagnostic.my_sqlcode('unit_tests_public.topics(boolean)','0'),'U08B0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.usenames_ex(boolean)',diagnostic.my_sqlcode('unit_tests_public.usenames_ex(boolean)','0'),'U08C0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.teachears_notes(boolean)',diagnostic.my_sqlcode('unit_tests_public.teachears_notes(boolean)','0'),'U08A0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.weekly_timetables(boolean)',diagnostic.my_sqlcode('unit_tests_public.weekly_timetables(boolean)','0'),'U08E0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.weekly_timetables_days(boolean)',diagnostic.my_sqlcode('unit_tests_public.weekly_timetables_days(boolean)','0'),'U08F0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.wikimedia_files(boolean)',diagnostic.my_sqlcode('unit_tests_public.wikimedia_files(boolean)','0'),'U08G0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.wikimedia_files_persons(boolean)',diagnostic.my_sqlcode('unit_tests_public.wikimedia_files_persons(boolean)','0'),'U08H0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.persons(boolean)',diagnostic.my_sqlcode('unit_tests_public.persons(boolean)','0'),'U07Y0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public._after_data_insert(boolean)',diagnostic.my_sqlcode('unit_tests_public._after_data_insert(boolean)','0'),'U06P0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.explanations_triggers(boolean)',diagnostic.my_sqlcode('unit_tests_public.explanations_triggers(boolean)','0'),'U0770');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.leavings_triggers(boolean)',diagnostic.my_sqlcode('unit_tests_public.leavings_triggers(boolean)','0'),'U07L0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.schools_behavior(boolean)',diagnostic.my_sqlcode('unit_tests_public.schools_behavior(boolean)','0'),'U0830');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.schools_foreign_key(boolean)',diagnostic.my_sqlcode('unit_tests_public.schools_foreign_key(boolean)','0'),'U0860');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.schools_check(boolean)',diagnostic.my_sqlcode('unit_tests_public.schools_check(boolean)','0'),'U0850');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.schools(boolean)',diagnostic.my_sqlcode('unit_tests_public.schools(boolean)','0'),'U0840');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.notes_signed(boolean)',diagnostic.my_sqlcode('unit_tests_public.notes_signed(boolean)','0'),'U07U0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.valutations(boolean)',diagnostic.my_sqlcode('unit_tests_public.valutations(boolean)','0'),'U08D0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.faults_triggers(boolean)',diagnostic.my_sqlcode('unit_tests_public.faults_triggers(boolean)','0'),'U0790');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.branches(boolean)',diagnostic.my_sqlcode('unit_tests_public.branches(boolean)','0'),'U06Q0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.classrooms_trigger(boolean)',diagnostic.my_sqlcode('unit_tests_public.classrooms_trigger(boolean)','0'),'U06V0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.conversations_invites(boolean)',diagnostic.my_sqlcode('unit_tests_public.conversations_invites(boolean)','0'),'U0700');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.degrees(boolean)',diagnostic.my_sqlcode('unit_tests_public.degrees(boolean)','0'),'U0720');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.delays_triggers(boolean)',diagnostic.my_sqlcode('unit_tests_public.delays_triggers(boolean)','0'),'U0740');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grading_meetings_valutations_triggers(boolean)',diagnostic.my_sqlcode('unit_tests_public.grading_meetings_valutations_triggers(boolean)','0'),'U07H0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.holidays(boolean)',diagnostic.my_sqlcode('unit_tests_public.holidays(boolean)','0'),'U07J0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grading_meetings_triggers(boolean)',diagnostic.my_sqlcode('unit_tests_public.grading_meetings_triggers(boolean)','0'),'U07E0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.classrooms_students_trigger(boolean)',diagnostic.my_sqlcode('unit_tests_public.classrooms_students_trigger(boolean)','0'),'U06U0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grading_meetings(boolean)',diagnostic.my_sqlcode('unit_tests_public.grading_meetings(boolean)','0'),'U07C0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.conversations(boolean)',diagnostic.my_sqlcode('unit_tests_public.conversations(boolean)','0'),'U06Z0');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.qualifications(boolean)',diagnostic.my_sqlcode('unit_tests_public.qualifications(boolean)','0'),'U0810');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.schools_trigger(boolean)',diagnostic.my_sqlcode('unit_tests_public.schools_trigger(boolean)','0'),'U0870');
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.communications_media_trigger(boolean)',diagnostic.my_sqlcode('unit_tests_public.communications_media_trigger(boolean)','0'),'U06X0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.absences_trigger(boolean)',diagnostic.my_sqlcode('unit_tests_public.absences_trigger(boolean)','0'),'U06N0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.leavings(boolean)',diagnostic.my_sqlcode('unit_tests_public.leavings(boolean)','0'),'U07K0');
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: unit_tests_public.grading_meetings_close(boolean)',diagnostic.my_sqlcode('unit_tests_public.grading_meetings_close(boolean)','0'),'U07D0');
