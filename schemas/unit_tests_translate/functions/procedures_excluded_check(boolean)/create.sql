-- Function: unit_tests_translate.procedures_excluded_check(boolean)

-- DROP FUNCTION unit_tests_translate.procedures_excluded_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests_translate.procedures_excluded_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_translate.procedures_excluded_check(boolean)
  OWNER TO postgres;
