-- Function: unit_tests_horizontal_security.check_user_school_disable(text, bigint)

-- DROP FUNCTION unit_tests_horizontal_security.check_user_school_disable(text, bigint);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_horizontal_security.check_user_school_disable(text, bigint)
  OWNER TO postgres;
