-- Function: unit_tests_security.leavings(boolean)

-- DROP FUNCTION unit_tests_security.leavings(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.leavings(
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.leavings SET teacher = '32937000000000' WHERE leaving = '58393000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.leavings WHERE leaving = '58393000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.leavings(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.leavings(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.leavings(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.leavings(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.leavings(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
