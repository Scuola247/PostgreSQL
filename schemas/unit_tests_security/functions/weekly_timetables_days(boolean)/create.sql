-- Function: unit_tests_security.weekly_timetables_days(boolean)

-- DROP FUNCTION unit_tests_security.weekly_timetables_days(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.weekly_timetables_days(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.weekly_timetables_days');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.weekly_timetables_days WHERE weekly_timetables_day = '33008000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.weekly_timetables_days SET subject = NULL WHERE weekly_timetables_day = '33008000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.weekly_timetables_days(weekly_timetable_day,weekly_timetable,weekday,teacher,subject,team_teaching,from_time,to_time) VALUES ('133008000000000','51386000000000','1','32925000000000','32911000000000','1','08:00:00','09:00:00');
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.weekly_timetables_days WHERE weekly_timetables_day = '33008000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.weekly_timetables_days(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables_days(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables_days(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables_days(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables_days(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
