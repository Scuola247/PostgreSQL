-- Function: unit_tests_security.classrooms_students(boolean)

-- DROP FUNCTION unit_tests_security.classrooms_students(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.classrooms_students(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.classrooms_students');
    RETURN;
  END IF;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.classrooms_students(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.classrooms_students(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.classrooms_students(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.classrooms_students(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.classrooms_students(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
