...
-- qualifications_plan
  _results = _results || unit_tests_security.check_statement_enabled(_usename,_group, ARRAY['scuola247_supervisor', 'scuola247_executive','scuola247_employee', 'scuola247_teacher', 'scuola247_student','scuola247_relative'], 'SELECT 1 from public.qualifications_plan WHERE  qualificationtion_plan = ''128989000000200'';', 1);
  _results = _results || unit_tests_security.check_statement_enabled(_usename,_group, ARRAY['scuola247_supervisor', 'scuola247_executive','scuola247_employee'], 'INSERT INTO public.qualifications_plan(qualificationtion_plan,qualification,degree,course_year,subject) VALUES (''1128989000000200'',''95978000000200'',''9947000000200'',''1'',''29107000000200'');', 1);
  _results = _results || unit_tests_security.check_statement_enabled(_usename,_group, ARRAY['scuola247_supervisor', 'scuola247_executive','scuola247_employee'], 'UPDATE public.qualifications_plan SET course_year = ''2'' WHERE  qualificationtion_plan = ''1128989000000200'';', 1);
  _results = _results || unit_tests_security.check_statement_enabled(_usename,_group, ARRAY['scuola247_supervisor', 'scuola247_executive','scuola247_employee'], 'DELETE FROM public.qualifications_plan WHERE  qualificationtion_plan = ''1128989000000200'';', 1);
...
-- usenames_schools -- sequenza diversa
  ...
  ELSE IF _group = ANY(ARRAY['scuola247_executive','scuola247_employee', 'scuola247_teacher', 'scuola247_student','scuola247_relative']) THEN
