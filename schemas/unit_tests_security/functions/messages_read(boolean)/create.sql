-- Function: unit_tests_security.messages_read(boolean)

-- DROP FUNCTION unit_tests_security.messages_read(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.messages_read(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.messages_read');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.messages_read WHERE message_read = '60304000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.messages_read SET message = '50113000000000' WHERE message_read = '60304000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.messages_read(message_read,message,person,read_on) VALUES ('1160304000000000','50112000000000','32925000000000','2013-09-16 16:26:43');
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.messages_read WHERE message_read = '60304000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.messages_read(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.messages_read(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.messages_read(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.messages_read(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.messages_read(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
