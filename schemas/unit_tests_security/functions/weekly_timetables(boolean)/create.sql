...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.weekly_timetables SET description = 'materia' WHERE weekly_timetable = '151386000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.weekly_timetables WHERE weekly_timetable = '151386000000000';
