-- Function: unit_tests_security.weekly_timetables(boolean)

-- DROP FUNCTION unit_tests_security.weekly_timetables(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.weekly_timetables(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.weekly_timetables');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.weekly_timetables WHERE weekly_timetable = '51386000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.weekly_timetables SET description = 'materia' WHERE weekly_timetable = '51386000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.weekly_timetables(weekly_timetable,classroom,description) VALUES ('151386000000000','10033000000000','descrizione');
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.weekly_timetables WHERE weekly_timetable = '51386000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.weekly_timetables(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.weekly_timetables(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
