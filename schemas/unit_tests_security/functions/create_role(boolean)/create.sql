...
BEGIN
  ...
  BEGIN
    ...
    PERFORM special.scuola247_create_user('test_unit_special_testing_user@scuola-200000200.it', 'scuola247_user'::special.scuola247_groups, 'it'::utility.language, 2000000200); 

    PERFORM special.scuola247_create_user('unit_testing_supervisor_security@scuola.it', 'scuola247_supervisor'::special.scuola247_groups, 'it'::utility.language, 2000000200, 2000000300);
    ...
    PERFORM special.scuola247_create_user('unit_testing_user_security@scuola.it', 'scuola247_user'::special.scuola247_groups, 'it'::utility.language, NULL);
