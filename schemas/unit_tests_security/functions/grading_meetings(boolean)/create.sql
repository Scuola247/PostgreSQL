...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.grading_meetings SET closed = 't' WHERE grading_meeting = '119537000000000';
...
GRANT EXECUTE ON FUNCTION unit_tests_security.grading_meetings(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
