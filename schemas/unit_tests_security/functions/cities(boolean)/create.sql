...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.cities SET description = 'descrizione non esistente' WHERE city = '758438000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.cities WHERE city = '758438000000000';
...
GRANT EXECUTE ON FUNCTION unit_tests_security.cities(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
