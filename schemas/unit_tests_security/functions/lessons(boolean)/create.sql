...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.lessons SET description = 'descrizione non esistente' WHERE lesson = '98581000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.lessons WHERE lesson = '98581000000000';
...
GRANT EXECUTE ON FUNCTION unit_tests_security.lessons(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
