-- Function: unit_tests_security.teachears_notes(boolean)

-- DROP FUNCTION unit_tests_security.teachears_notes(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.teachears_notes(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.teachears_notes');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.teachears_notes WHERE teacher_notes = '61764000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.teachears_notes SET description = 'descrizione' WHERE teacher_notes = '61764000000000';    
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.teachears_notes(teacher_notes,student,description,teacher,on_date,at_time,classroom) VALUES ('161764000000000','6617000000000','alunno con difficoltÃ  nell''apprendimento','32926000000000','2014-02-25',NULL,'10033000000000');
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.teachears_notes(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.teachears_notes(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.teachears_notes(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.teachears_notes(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.teachears_notes(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
