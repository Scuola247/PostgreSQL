...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.teachears_notes SET description = 'descrizione' WHERE teacher_notes = '161764000000000';    
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.teachears_notes WHERE teacher_notes = '161764000000000';
