-- Function: unit_tests_security.signatures(boolean)

-- DROP FUNCTION unit_tests_security.signatures(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.signatures(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.signatures');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.signatures WHERE signature = '33773000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.signatures SET classroom = '10036000000000' WHERE signature = '33773000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.signatures(signature,classroom,teacher,on_date,at_time) VALUES ('133773000000000','10035000000000','32931000000000','2013-10-05','09:47:57');
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.signatures(boolean)
  OWNER TO "jiahaodong@gmail.com";
GRANT EXECUTE ON FUNCTION unit_tests_security.signatures(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.signatures(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.signatures(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.signatures(boolean) TO scuola247_user;
