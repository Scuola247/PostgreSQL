...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.classrooms SET description = 'sede non esistente' WHERE classroom = '10062000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.classrooms WHERE classroom = '10062000000000';
...
GRANT EXECUTE ON FUNCTION unit_tests_security.classrooms(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
