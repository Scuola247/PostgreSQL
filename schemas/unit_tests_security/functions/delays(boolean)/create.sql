-- Function: unit_tests_security.delays(boolean)

-- DROP FUNCTION unit_tests_security.delays(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.delays(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.delays');
    RETURN;
  END IF;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.delays(boolean)
