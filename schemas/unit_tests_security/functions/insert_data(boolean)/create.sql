...
BEGIN
  ...
  BEGIN
    -- primo istituto
    INSERT INTO schools (school, description, processing_code, mnemonic, example, logo, behavior) VALUES (2000000200, 'Istituto Tecnico Tecnologico "Leonardo da Vinci22"', 'AZITT2000Z', 'ITT DAVINCI22', true, NULL, NULL);

    INSERT INTO branches (branch, school, description) VALUES (9954000000200, 2000000200, 'Filiale Borgo Roma');

    INSERT INTO degrees (degree, school, description, course_years) VALUES (9947000000200, 2000000200, 'Informatica', 5);

    -- Student
    INSERT INTO public.persons(person,name,surname,born,deceased,country_of_birth,tax_code,sex,school,sidi,city_of_birth_fiscal_code,thumbnail,note,usename,photo,city_of_birth) VALUES ('2358000000200','Gabriel','Tiberi','1996-05-18',NULL,NULL,'TBRGBR96E58L781M','F','2000000200',NULL,'L781',NULL,NULL,NULL,NULL,'761554000000000');
    ...
    INSERT INTO school_years (school_year, school, description, duration, lessons_duration) VALUES (244000000200, 2000000200, '2013/2014', '[2013-09-11,2014-09-11)', '[2013-09-11,2014-06-08)');
    ...
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130752000000200','119537000000200','10062000000200','2358000000200','29105000000200','29086000000200',NULL,'f','f',NULL);
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130753000000200','119533000000200','10062000000200','2358000000200','29106000000200','29090000000200','Esempio di una nota associata ad un voto di scrutinio','f','f',NULL);
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130754000000200','119537000000200','10062000000200','2359000000200','29105000000200','29090000000200',NULL,'f','f',NULL);
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130755000000200','119533000000200','10062000000200','2359000000200','29106000000200','29094000000200','Esempio di una nota associata ad un voto di scrutinio','f','f',NULL);
    ...
    INSERT INTO communication_types (communication_type, description, notification_management, school) VALUES (138016000000200,'email',TRUE,2000000200);
    INSERT INTO communication_types (communication_type, description, notification_management, school) VALUES (138017000000200,'SMS',TRUE,2000000200);
    ...
    -- schools_behavior
    UPDATE schools SET behavior = 29107000000200 WHERE school = 2000000200;
    ...
    -- secondo istituto
    INSERT INTO schools (school, description, processing_code, mnemonic, example, logo, behavior) VALUES (2000000300, 'Istituto Tecnico Tecnologico "Leonardo da Vinci23"', 'AZITT3000Z', 'ITT DAVINCI23', true, NULL, NULL);

    INSERT INTO branches (branch, school, description) VALUES (9954000000300, 2000000300, 'Filiale Borgo Roma');

    INSERT INTO degrees (degree, school, description, course_years) VALUES (9947000000300, 2000000300, 'Informatica', 5);

    -- Student
    INSERT INTO public.persons(person,name,surname,born,deceased,country_of_birth,tax_code,sex,school,sidi,city_of_birth_fiscal_code,thumbnail,note,usename,photo,city_of_birth) VALUES ('2358000000300','Gabriel','Tiberi','1996-05-18',NULL,NULL,'TBRGBR96E58L781M','F','2000000300',NULL,'L781',NULL,NULL,NULL,NULL,'761554000000000');
    ...
    INSERT INTO school_years (school_year, school, description, duration, lessons_duration) VALUES (244000000300, 2000000300, '2013/2014', '[2013-09-11,2014-09-11)', '[2013-09-11,2014-06-08)');
    ...
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130752000000300','119537000000300','10062000000300','2358000000300','29105000000300','29086000000300',NULL,'f','f',NULL);
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130753000000300','119533000000300','10062000000300','2358000000300','29106000000300','29090000000300','Esempio di una nota associata ad un voto di scrutinio','f','f',NULL);
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130754000000300','119537000000300','10062000000300','2359000000300','29105000000300','29090000000300',NULL,'f','f',NULL);
    INSERT INTO public.grading_meetings_valutations(grading_meeting_valutation,grading_meeting,classroom,student,subject,grade,notes,lack_of_training,council_vote,teacher) VALUES ('130755000000300','119533000000300','10062000000300','2359000000300','29106000000300','29094000000300','Esempio di una nota associata ad un voto di scrutinio','f','f',NULL);
    ...
    INSERT INTO communication_types (communication_type, description, notification_management, school) VALUES (138016000000300,'email',TRUE,2000000300);
    INSERT INTO communication_types (communication_type, description, notification_management, school) VALUES (138017000000300,'SMS',TRUE,2000000300);
    ...
    -- schools_behavior
    UPDATE schools SET behavior = 29107000000300 WHERE school = 2000000300;
