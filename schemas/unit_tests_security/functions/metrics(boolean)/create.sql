-- Function: unit_tests_security.metrics(boolean)

-- DROP FUNCTION unit_tests_security.metrics(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.metrics(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.metrics');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.metrics WHERE metric = '11433000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.metrics SET description = 'sede non esistente' WHERE metric = '11433000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.metrics(metric,school,description,sufficiency) VALUES ('1111433000000000','1000000000','Decimale','600');
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.metrics WHERE metric = '11433000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.metrics(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.metrics(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.metrics(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.metrics(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.metrics(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
