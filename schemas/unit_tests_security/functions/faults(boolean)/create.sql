-- Function: unit_tests_security.faults(boolean)

-- DROP FUNCTION unit_tests_security.faults(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.faults(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.faults');
    RETURN;
  END IF;
...
END;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.faults SET description = 'non ha il quaderno' WHERE fault = '59632000000000';
...
END;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.faults WHERE fault = '59632000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.faults(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.faults(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.faults(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.faults(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.faults(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
