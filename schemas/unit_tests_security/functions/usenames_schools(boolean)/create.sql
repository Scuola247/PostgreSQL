-- Function: unit_tests_security.usenames_schools(boolean)

-- DROP FUNCTION unit_tests_security.usenames_schools(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.usenames_schools(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.usenames_schools');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.usename_schools WHERE usename_school = '726621000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.usenames_schools(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.usenames_schools(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.usenames_schools(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.usenames_schools(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.usenames_schools(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
