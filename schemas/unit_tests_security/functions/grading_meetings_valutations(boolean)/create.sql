-- Function: unit_tests_security.grading_meeting_valutation(boolean)

-- DROP FUNCTION unit_tests_security.grading_meeting_valutation(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.grading_meeting_valutation(
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.grading_meetings_valutations SET lack_of_training = 't' WHERE grading_meeting_valutation = '130813000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.grading_meetings_valutations WHERE grading_meeting_valutation = '130813000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-supervisor@scuola.it';
    UPDATE public.grading_meetings_valutations SET lack_of_training = 't' WHERE explanation = '47599000000000';    
    _results = _results || assert.pass(full_function_name, test_name);
 EXCEPTION WHEN SQLSTATE '42501' THEN 
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-supervisor@scuola.it';
    DELETE FROM public.grading_meetings_valutations WHERE explanation = '47599000000000';
    _results = _results || assert.pass(full_function_name, test_name);
 EXCEPTION WHEN SQLSTATE '42501' THEN 
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.grading_meeting_valutation(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.grading_meeting_valutation(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.grading_meeting_valutation(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.grading_meeting_valutation(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.grading_meeting_valutation(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
