-- Function: unit_tests_security.topics(boolean)

-- DROP FUNCTION unit_tests_security.topics(boolean);

CREATE OR REPLACE FUNCTION unit_tests_security.topics(
...
BEGIN
  ...
  IF _build_dependencies THEN
      PERFORM unit_testing.build_function_dependencies(diagnostic.function_name(context),'unit_tests_security.create_role','unit_tests_public.topics');
    RETURN;
  END IF;
 ...
 BEGIN
    ...
    PERFORM 1 from public.topics WHERE topic = '33242000000000';
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    UPDATE public.topics SET description = 'descrizione' WHERE topic = '33242000000000';    
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    INSERT INTO public.topics(topic,subject,description,course_year,degree) VALUES ('133242000000000','32911000000000','descrizione','1','9944000000000');
...
RESET ROLE;
 ...
 BEGIN
    SET ROLE 'test-student-a@scuola-1.it';
    DELETE FROM public.topics WHERE topic = '33242000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_security.topics(boolean)
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION unit_tests_security.topics(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_security.topics(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_security.topics(boolean) TO scuola247_user;
GRANT EXECUTE ON FUNCTION unit_tests_security.topics(boolean) TO "jiahaodong@gmail.com" WITH GRANT OPTION;
