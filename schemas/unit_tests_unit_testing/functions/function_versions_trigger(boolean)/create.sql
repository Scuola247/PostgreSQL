-- Function: unit_tests_unit_testing.function_versions_trigger(boolean)

-- DROP FUNCTION unit_tests_unit_testing.function_versions_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests_unit_testing.function_versions_trigger(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_unit_testing.function_versions_trigger(boolean)
  OWNER TO postgres;
