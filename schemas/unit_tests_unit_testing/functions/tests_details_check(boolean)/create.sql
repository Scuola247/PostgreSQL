-- Function: unit_tests_unit_testing.tests_details_check(boolean)

-- DROP FUNCTION unit_tests_unit_testing.tests_details_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests_unit_testing.tests_details_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_unit_testing.tests_details_check(boolean)
  OWNER TO postgres;
