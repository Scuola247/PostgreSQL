-- Function: unit_tests_unit_testing.nothing_function(boolean)

-- DROP FUNCTION unit_tests_unit_testing.nothing_function(boolean);

CREATE OR REPLACE FUNCTION unit_tests_unit_testing.nothing_function(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_unit_testing.nothing_function(boolean)
  OWNER TO postgres;