...
GRANT EXECUTE ON FUNCTION unit_tests_public.weekly_timetables_days_check(boolean) TO public;
GRANT EXECUTE ON FUNCTION unit_tests_public.weekly_timetables_days_check(boolean) TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION unit_tests_public.weekly_timetables_days_check(boolean) TO scuola247_user;
