...
BEGIN
  ...
  BEGIN
    ...
    _results = _results || assert.sqlstate_constraint_equals(me.full_function_name, me.test_name, me.error, '23503','grading_meetings_valutations_fk_classrooms_students');
