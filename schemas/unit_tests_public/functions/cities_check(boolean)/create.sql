...
/*
  ...
  -------------------------------------------------
  BEGIN
    INSERT INTO public.cities(fiscal_code,description,district,city) VALUES ('01','Airasca (test)','758321000000000','758437000000000');
 ...
 */
  -------------------------------------------------
  test_name = 'duplicate description and district'; -- Non funziona con l'Update, lo fa passare;
  -------------------------------------------------
  BEGIN
   ...
   _results =  _results || assert.fail(full_function_name, test_name, 'Insert was OK but duplicate description was expected', NULL::diagnostic.error);
	...
	_results =  _results || assert.fail(full_function_name, test_name, 'Unexpected exception', error);
        RETURN;
  END;-- Function: unit_tests_public.cities_check(boolean)
...
BEGIN
 ...
 /*
  ...
  -------------------------------------------------
  test_name = 'duplicate district and description'; -- Non funziona con l'Update, lo fa passare;
  -------------------------------------------------
  BEGIN
 ...
 */
  ------------------------------------
  test_name = 'duplicate fiscal_code'; -- con l'insert invece la intercetta
  ------------------------------------
  BEGIN
