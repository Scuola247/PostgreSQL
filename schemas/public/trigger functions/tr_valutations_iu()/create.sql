...
--
-- store the school, classroom and the student
--
...
--
  IF  new.private AND new.note IS NOT NULL THEN
    IF (TG_OP = 'UPDATE') THEN
      RAISE EXCEPTION USING
...
GRANT EXECUTE ON FUNCTION public.tr_valutations_iu() TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION public.tr_valutations_iu() TO scuola247_relative;
GRANT EXECUTE ON FUNCTION public.tr_valutations_iu() TO scuola247_user;
