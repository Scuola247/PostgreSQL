...
-- 
-- store school, classroom and student
--
...
--
  ...
  END IF;
--
-- check that the explanation, if indicated, both related to that student, at that on_date of leaving within explanation
--   
...
GRANT EXECUTE ON FUNCTION public.tr_leavings_iu() TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION public.tr_leavings_iu() TO scuola247_relative;
GRANT EXECUTE ON FUNCTION public.tr_leavings_iu() TO scuola247_user;
