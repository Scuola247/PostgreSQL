-- Function: unit_tests_horizontal_security.check_user_disable_school(text, bigint)

-- DROP FUNCTION unit_tests_horizontal_security.check_user_disable_school(text, bigint);
...
LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION unit_tests_horizontal_security.check_user_disable_school(text, bigint)
  OWNER TO postgres;
