-- Function: unit_tests_horizontal_security.check_user_enable_school(text, text, bigint)

-- DROP FUNCTION unit_tests_horizontal_security.check_user_enable_school(text, text, bigint);
...
BEGIN
  ...
  MANCA LA COSTRUZIONE DELLE DEPENDENCIES 
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_horizontal_security.check_user_enable_school(text, text, bigint)
  OWNER TO postgres;
