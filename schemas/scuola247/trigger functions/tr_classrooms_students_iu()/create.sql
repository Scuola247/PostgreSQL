-- Function: scuola247.tr_classrooms_students_iu()

-- DROP FUNCTION scuola247.tr_classrooms_students_iu();

CREATE OR REPLACE FUNCTION scuola247.tr_classrooms_students_iu()
  RETURNS trigger AS
$BODY$
<<me>>
DECLARE
...
--
  PERFORM 1 
     FROM scuola247.classrooms c
     JOIN scuola247.school_years sy ON sy.school_year = c.school_year
     JOIN scuola247.persons p ON sy.school = p.school
  ...
  END IF;
  --
-- Check that the student is in role students
--
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION scuola247.tr_classrooms_students_iu()
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION scuola247.tr_classrooms_students_iu() TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION scuola247.tr_classrooms_students_iu() TO scuola247_user;
GRANT EXECUTE ON FUNCTION scuola247.tr_classrooms_students_iu() TO scuola247_relative;
REVOKE ALL ON FUNCTION scuola247.tr_classrooms_students_iu() FROM public;
