-- Function: scuola247.tr_classrooms_iu()

-- DROP FUNCTION scuola247.tr_classrooms_iu();

CREATE OR REPLACE FUNCTION scuola247.tr_classrooms_iu()
  RETURNS trigger AS
$BODY$
<<me>>
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION scuola247.tr_classrooms_iu() SET search_path=public, utility, pg_temp;

ALTER FUNCTION scuola247.tr_classrooms_iu()
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION scuola247.tr_classrooms_iu() TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION scuola247.tr_classrooms_iu() TO scuola247_user;
REVOKE ALL ON FUNCTION scuola247.tr_classrooms_iu() FROM public;
