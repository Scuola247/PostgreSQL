-- Function: scuola247.tr_explanations_iu()

-- DROP FUNCTION scuola247.tr_explanations_iu();

CREATE OR REPLACE FUNCTION scuola247.tr_explanations_iu()
  RETURNS trigger AS
$BODY$
<<me>>
DECLARE
...
BEGIN 
  ...
  ELSE
    PERFORM 1 
       FROM scuola247.persons_relations pr
       JOIN scuola247.persons p ON pr.person_related_to = p.person
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION scuola247.tr_explanations_iu()
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION scuola247.tr_explanations_iu() TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION scuola247.tr_explanations_iu() TO scuola247_user;
REVOKE ALL ON FUNCTION scuola247.tr_explanations_iu() FROM public;
