-- Function: scuola247.tr_grading_meetings_iu()

-- DROP FUNCTION scuola247.tr_grading_meetings_iu();

CREATE OR REPLACE FUNCTION scuola247.tr_grading_meetings_iu()
  RETURNS trigger AS
$BODY$
<<me>>
DECLARE
...
BEGIN
  ...
  --
  PERFORM 1 FROM scuola247.vgrading_meetings s
     JOIN scuola247.school_years sy ON sy.school_year = s.school_year
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION scuola247.tr_grading_meetings_iu()
  OWNER TO scuola247_supervisor;
GRANT EXECUTE ON FUNCTION scuola247.tr_grading_meetings_iu() TO scuola247_supervisor WITH GRANT OPTION;
GRANT EXECUTE ON FUNCTION scuola247.tr_grading_meetings_iu() TO scuola247_user;
REVOKE ALL ON FUNCTION scuola247.tr_grading_meetings_iu() FROM public;
