-- Function: unit_tests.holidays_check(boolean)

-- DROP FUNCTION unit_tests.holidays_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.holidays_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.holidays_check(boolean)
  OWNER TO postgres;
