-- Function: unit_tests.notes_trigger(boolean)

-- DROP FUNCTION unit_tests.notes_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests.notes_trigger(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.notes_trigger(boolean)
  OWNER TO postgres;
