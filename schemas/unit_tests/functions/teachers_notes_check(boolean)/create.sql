-- Function: unit_tests.teachears_notes_check(boolean)

-- DROP FUNCTION unit_tests.teachears_notes_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.teachears_notes_check(
...
BEGIN
  ...
  BEGIN
    ...
    EXCEPTION WHEN SQLSTATE '23505' THEN 
      ...
      IF error.constraint_name = 'teachears_notes_uq_on_date_at_time' THEN
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.teachears_notes_check(boolean)
  OWNER TO postgres;
