-- Function: unit_tests.school_years(boolean)

-- DROP FUNCTION unit_tests.school_years(boolean);

CREATE OR REPLACE FUNCTION unit_tests.school_years(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.school_years(boolean)
  OWNER TO postgres;
