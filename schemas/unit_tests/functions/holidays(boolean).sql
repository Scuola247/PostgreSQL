-- Function: unit_tests.holidays(boolean)

-- DROP FUNCTION unit_tests.holidays(boolean);

CREATE OR REPLACE FUNCTION unit_tests.holidays(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.holidays(boolean)
  OWNER TO postgres;
