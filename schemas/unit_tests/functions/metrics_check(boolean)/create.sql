-- Function: unit_tests.metrics_check(boolean)

-- DROP FUNCTION unit_tests.metrics_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.metrics_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.metrics_check(boolean)
  OWNER TO postgres;
