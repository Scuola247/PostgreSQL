...
-- DROP FUNCTION unit_tests.messages_read_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests.messages_read_trigger(
...
BEGIN
  ...
  --------------------------------------------------------------
  test_name = 'UPDATE messages_read with a person of a different school';
  --------------------------------------------------------------
  BEGIN
  ...
  --------------------------------------------------------------
  test_name = 'INSERT messages_read with a person of a different school';
  --------------------------------------------------------------
  BEGIN
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.messages_read_trigger(boolean)
  OWNER TO postgres;
