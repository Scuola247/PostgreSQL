...
BEGIN
 ...
 BEGIN
  ...
  -----------------------------------
  BEGIN
    UPDATE persons_roles SET person_role = NULL WHERE person_role ='156239000000000' ;
    _results = _results || assert.fail(full_function_name, test_name, 'Update was OK but person_role mandatory was expected', NULL::diagnostic.error);      
    RETURN;
