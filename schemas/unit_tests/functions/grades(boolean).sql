-- Function: unit_tests.grades(boolean)

-- DROP FUNCTION unit_tests.grades(boolean);

CREATE OR REPLACE FUNCTION unit_tests.grades(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.grades(boolean)
  OWNER TO postgres;
