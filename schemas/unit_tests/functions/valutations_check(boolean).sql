-- Function: unit_tests.valutations_check(boolean)

-- DROP FUNCTION unit_tests.valutations_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.valutations_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.valutations_check(boolean)
  OWNER TO postgres;
