-- Function: unit_tests.subjects_foreign_key(boolean)

-- DROP FUNCTION unit_tests.subjects_foreign_key(boolean);

CREATE OR REPLACE FUNCTION unit_tests.subjects_foreign_key(
