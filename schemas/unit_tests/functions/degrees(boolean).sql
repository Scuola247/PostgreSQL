-- Function: unit_tests.degrees(boolean)

-- DROP FUNCTION unit_tests.degrees(boolean);

CREATE OR REPLACE FUNCTION unit_tests.degrees(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.degrees(boolean)
  OWNER TO postgres;
