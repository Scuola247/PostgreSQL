-- Function: unit_tests.wikimedia_files_check(boolean)

-- DROP FUNCTION unit_tests.wikimedia_files_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.wikimedia_files_check(
...
BEGIN
  ...
  BEGIN
    ...
    EXCEPTION WHEN SQLSTATE '23514' THEN 
      ...
      IF error.constraint_name = 'wikimedia_files_ck_name' THEN
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.wikimedia_files_check(boolean)
  OWNER TO postgres;
