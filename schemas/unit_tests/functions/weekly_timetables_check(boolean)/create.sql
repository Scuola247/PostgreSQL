-- Function: unit_tests.weekly_timetables_check(boolean)

-- DROP FUNCTION unit_tests.weekly_timetables_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.weekly_timetables_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.weekly_timetables_check(boolean)
  OWNER TO postgres;
