-- Function: unit_tests.conversations_check(boolean)

-- DROP FUNCTION unit_tests.conversations_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.conversations_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.conversations_check(boolean)
  OWNER TO postgres;
