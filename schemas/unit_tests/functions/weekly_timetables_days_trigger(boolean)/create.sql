-- Function: unit_tests.weekly_timetables_days_trigger(boolean)

-- DROP FUNCTION unit_tests.weekly_timetables_days_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests.weekly_timetables_days_trigger(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.weekly_timetables_days_trigger(boolean)
  OWNER TO postgres;
