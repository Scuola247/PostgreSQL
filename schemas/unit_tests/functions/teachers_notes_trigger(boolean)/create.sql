...
BEGIN
  ...
  -----------------------------
  test_name = 'UPDATE teachers_notes set the data to a sunday ';
  ------------------------------
 BEGIN
  ...
  -----------------------------
  test_name = 'INSERT teachers_notes set the data to a sunday ';
  ------------------------------
 BEGIN
    ...
    _results = _results || assert.fail(full_function_name, test_name,'Inser was OK but the day is a sunday', NULL::diagnostic.error);
    RETURN;
  ...
  -----------------------------
  test_name = 'UPDATE teachers_notes set the student from another school ';
  ------------------------------
 BEGIN
    UPDATE public.teachears_notes SET student = '9804000000000' WHERE teacher_notes = '61764000000000';
    _results = _results || assert.fail(full_function_name, test_name,'Update was OK but the student is from another school', NULL::diagnostic.error);
    RETURN;
  ...
  -----------------------------
  test_name = 'INSERT teachers_notes set the student from another school ';
  ------------------------------
 BEGIN
    ...
    _results = _results || assert.fail(full_function_name, test_name,'Insert was OK but the student is from another school', NULL::diagnostic.error);
    RETURN;
  ...
  -----------------------------
  test_name = 'UPDATE teachers_notes set the teacher from another school ';
  ------------------------------
 BEGIN
  ...
  -----------------------------
  test_name = 'INSERT teachers_notes set the teacher from another school ';
  ------------------------------
 BEGIN
