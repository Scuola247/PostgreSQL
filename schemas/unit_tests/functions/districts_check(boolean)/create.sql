...
BEGIN
  ...
  */
  ...
  --------------------------------------------------
  BEGIN
    INSERT INTO public.districts(mnemonic,description,region,district) VALUES ('AA','Torino','2000000000','758321000000000');
  ...
  ---------------------------------
  BEGIN
    UPDATE districts SET mnemonic = NULL WHERE district = '758322000000000';
  ...
  ------------------------------------
  BEGIN
    UPDATE districts SET description = NULL WHERE district = '758322000000000';
