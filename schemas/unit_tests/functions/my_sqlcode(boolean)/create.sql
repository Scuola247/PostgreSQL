...
BEGIN
  ...
  BEGIN
    ...
    */
    ...
    _results = _results || assert.are_equals(full_function_name,'CHECK my_sqlcode: public.tr_valutations_qualificationtions_iu()',diagnostic.my_sqlcode('public.tr_valutations_qualificationtions_iu()','0'),'U0580');
