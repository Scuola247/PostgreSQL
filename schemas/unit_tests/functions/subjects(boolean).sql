-- Function: unit_tests.subjects(boolean)

-- DROP FUNCTION unit_tests.subjects(boolean);

CREATE OR REPLACE FUNCTION unit_tests.subjects(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.subjects(boolean)
  OWNER TO postgres;
