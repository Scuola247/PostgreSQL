-- Function: unit_tests_public.schools_years_check(boolean)

-- DROP FUNCTION unit_tests_public.schools_years_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests_public.schools_years_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests_public.schools_years_check(boolean)
  OWNER TO postgres;
