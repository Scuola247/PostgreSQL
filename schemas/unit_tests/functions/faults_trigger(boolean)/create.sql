-- Function: unit_tests.faults_trigger(boolean)

-- DROP FUNCTION unit_tests.faults_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests.faults_trigger(
...
BEGIN
  ...
  -------------------------------------------------------------------------
  BEGIN
    UPDATE public.faults set student = '2012000000000' WHERE lesson = '102279000000000';
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.faults_trigger(boolean)
  OWNER TO postgres;
