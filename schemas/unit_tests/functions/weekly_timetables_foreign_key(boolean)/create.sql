-- Function: unit_tests.weekly_timetables_foreign_key(boolean)

-- DROP FUNCTION unit_tests.weekly_timetables_foreign_key(boolean);

CREATE OR REPLACE FUNCTION unit_tests.weekly_timetables_foreign_key(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.weekly_timetables_foreign_key(boolean)
  OWNER TO postgres;
