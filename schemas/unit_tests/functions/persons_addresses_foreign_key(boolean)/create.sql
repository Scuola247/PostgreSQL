-- Function: unit_tests.persons_addresses_foreign_key(boolean)

-- DROP FUNCTION unit_tests.persons_addresses_foreign_key(boolean);

CREATE OR REPLACE FUNCTION unit_tests.persons_addresses_foreign_key(
...
BEGIN
  ...
  END IF;  
  ---------------------------------------------------------------------------
  test_name = 'update persons_addresses set person with a non existing one';
  ---------------------------------------------------------------------------
  BEGIN
  ...
  END; 
  ---------------------------------------------------------------------------
  test_name = 'update persons_addresses set city with a non existing one';
  ---------------------------------------------------------------------------
  BEGIN
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.persons_addresses_foreign_key(boolean)
  OWNER TO postgres;
