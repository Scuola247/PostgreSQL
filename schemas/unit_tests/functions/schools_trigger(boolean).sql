-- Function: unit_tests.schools_trigger(boolean)

-- DROP FUNCTION unit_tests.schools_trigger(boolean);

CREATE OR REPLACE FUNCTION unit_tests.schools_trigger(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.schools_trigger(boolean)
  OWNER TO postgres;
