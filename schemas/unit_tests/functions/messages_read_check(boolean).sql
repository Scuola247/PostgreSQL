...
-- DROP FUNCTION unit_tests.messages_read_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.messages_read_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.messages_read_check(boolean)
  OWNER TO postgres;
