-- Function: unit_tests.notes_signed_foreign_key(boolean)

-- DROP FUNCTION unit_tests.notes_signed_foreign_key(boolean);

CREATE OR REPLACE FUNCTION unit_tests.notes_signed_foreign_key(
...
BEGIN
  ...
  ---------------------------------------------------------------------
  test_name = 'update notes_signed set note with non existence code';
  ---------------------------------------------------------------------
  BEGIN
  ...
  ---------------------------------------------------------------------
  test_name = 'update notes_signed_fk_person set person with non existence code';
  ---------------------------------------------------------------------
  BEGIN
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.notes_signed_foreign_key(boolean)
  OWNER TO postgres;
