-- Function: unit_tests.grading_meetings_check(boolean)

-- DROP FUNCTION unit_tests.grading_meetings_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.grading_meetings_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.grading_meetings_check(boolean)
  OWNER TO postgres;
