-- Function: unit_tests.topics_check(boolean)

-- DROP FUNCTION unit_tests.topics_check(boolean);

CREATE OR REPLACE FUNCTION unit_tests.topics_check(
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION unit_tests.topics_check(boolean)
  OWNER TO postgres;
