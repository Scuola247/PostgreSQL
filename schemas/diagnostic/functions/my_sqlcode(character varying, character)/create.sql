...
--
  ...
  IF _function = 'unit_tests_public.absences(boolean)' THEN RETURN 'U06M' || _id; END IF;
  IF _function = 'unit_tests_public.absences_trigger(boolean)' THEN RETURN 'U06N' || _id; END IF;
  IF _function = 'unit_tests_public._after_data_insert(boolean)' THEN RETURN 'U06P' || _id; END IF;
  IF _function = 'unit_tests_public.branches(boolean)' THEN RETURN 'U06Q' || _id; END IF;
  IF _function = 'unit_tests_public.cities(boolean)' THEN RETURN 'U06R' || _id; END IF;
  IF _function = 'unit_tests_public.classrooms(boolean)' THEN RETURN 'U06S' || _id; END IF;
  IF _function = 'unit_tests_public.classrooms_students(boolean)' THEN RETURN 'U06T' || _id; END IF;
  IF _function = 'unit_tests_public.classrooms_students_trigger(boolean)' THEN RETURN 'U06U' || _id; END IF;
  IF _function = 'unit_tests_public.classrooms_trigger(boolean)' THEN RETURN 'U06V' || _id; END IF;
  IF _function = 'unit_tests_public.communications_media(boolean)' THEN RETURN 'U06W' || _id; END IF;
  IF _function = 'unit_tests_public.communications_media_trigger(boolean)' THEN RETURN 'U06X' || _id; END IF;
  IF _function = 'unit_tests_public.communication_types(boolean)' THEN RETURN 'U06Y' || _id; END IF;
  IF _function = 'unit_tests_public.conversations(boolean)' THEN RETURN 'U06Z' || _id; END IF;
  IF _function = 'unit_tests_public.conversations_invites(boolean)' THEN RETURN 'U070' || _id; END IF;
  IF _function = 'unit_tests_public.countries(boolean)' THEN RETURN 'U071' || _id; END IF;
  IF _function = 'unit_tests_public.degrees(boolean)' THEN RETURN 'U072' || _id; END IF;
  IF _function = 'unit_tests_public.delays(boolean)' THEN RETURN 'U073' || _id; END IF;
  IF _function = 'unit_tests_public.delays_triggers(boolean)' THEN RETURN 'U074' || _id; END IF;
  IF _function = 'unit_tests_public.districts(boolean)' THEN RETURN 'U075' || _id; END IF;
  IF _function = 'unit_tests_public.explanations(boolean)' THEN RETURN 'U076' || _id; END IF;
  IF _function = 'unit_tests_public.explanations_triggers(boolean)' THEN RETURN 'U077' || _id; END IF;
  IF _function = 'unit_tests_public.faults(boolean)' THEN RETURN 'U078' || _id; END IF;
  IF _function = 'unit_tests_public.faults_triggers(boolean)' THEN RETURN 'U079' || _id; END IF;
  IF _function = 'unit_tests_public.grades(boolean)' THEN RETURN 'U07A' || _id; END IF;
  IF _function = 'unit_tests_public.grade_types(boolean)' THEN RETURN 'U07B' || _id; END IF;
  IF _function = 'unit_tests_public.grading_meetings(boolean)' THEN RETURN 'U07C' || _id; END IF;
  IF _function = 'unit_tests_public.grading_meetings_close(boolean)' THEN RETURN 'U07D' || _id; END IF;
  IF _function = 'unit_tests_public.grading_meetings_triggers(boolean)' THEN RETURN 'U07E' || _id; END IF;
  IF _function = 'unit_tests_public.grading_meetings_valutations(boolean)' THEN RETURN 'U07F' || _id; END IF;
  IF _function = 'unit_tests_public.grading_meetings_valutations_qua(boolean)' THEN RETURN 'U07G' || _id; END IF;
  IF _function = 'unit_tests_public.grading_meetings_valutations_triggers(boolean)' THEN RETURN 'U07H' || _id; END IF;
  IF _function = 'unit_tests_public.holidays(boolean)' THEN RETURN 'U07J' || _id; END IF;
  IF _function = 'unit_tests_public.leavings(boolean)' THEN RETURN 'U07K' || _id; END IF;
  IF _function = 'unit_tests_public.leavings_triggers(boolean)' THEN RETURN 'U07L' || _id; END IF;
  IF _function = 'unit_tests_public.lessons(boolean)' THEN RETURN 'U07M' || _id; END IF;
  IF _function = 'unit_tests_public.messages(boolean)' THEN RETURN 'U07N' || _id; END IF;
  ...
  IF _function = 'unit_tests_public.parents_meetings(boolean)' THEN RETURN 'U07W' || _id; END IF;
  IF _function = 'unit_tests_public.persons_addresses(boolean)' THEN RETURN 'U07X' || _id; END IF;
  IF _function = 'unit_tests_public.persons(boolean)' THEN RETURN 'U07Y' || _id; END IF;
  IF _function = 'unit_tests_public.persons_relations(boolean)' THEN RETURN 'U07Z' || _id; END IF;
  IF _function = 'unit_tests_public.persons_roles(boolean)' THEN RETURN 'U080' || _id; END IF;
  IF _function = 'unit_tests_public.qualifications(boolean)' THEN RETURN 'U081' || _id; END IF;
  IF _function = 'unit_tests_public.regions(boolean)' THEN RETURN 'U082' || _id; END IF;
  IF _function = 'unit_tests_public.schools_behavior(boolean)' THEN RETURN 'U083' || _id; END IF;
  IF _function = 'unit_tests_public.schools(boolean)' THEN RETURN 'U084' || _id; END IF;
  IF _function = 'unit_tests_public.schools_check(boolean)' THEN RETURN 'U085' || _id; END IF;
  IF _function = 'unit_tests_public.schools_foreign_key(boolean)' THEN RETURN 'U086' || _id; END IF;
  IF _function = 'unit_tests_public.schools_trigger(boolean)' THEN RETURN 'U087' || _id; END IF;
  IF _function = 'unit_tests_public.school_years(boolean)' THEN RETURN 'U088' || _id; END IF;
  IF _function = 'unit_tests_public.subjects(boolean)' THEN RETURN 'U089' || _id; END IF;
  IF _function = 'unit_tests_public.teachears_notes(boolean)' THEN RETURN 'U08A' || _id; END IF;
  IF _function = 'unit_tests_public.topics(boolean)' THEN RETURN 'U08B' || _id; END IF;
  IF _function = 'unit_tests_public.usenames_ex(boolean)' THEN RETURN 'U08C' || _id; END IF;
  IF _function = 'unit_tests_public.valutations(boolean)' THEN RETURN 'U08D' || _id; END IF;
  IF _function = 'unit_tests_public.weekly_timetables(boolean)' THEN RETURN 'U08E' || _id; END IF;
  IF _function = 'unit_tests_public.weekly_timetables_days(boolean)' THEN RETURN 'U08F' || _id; END IF;
  IF _function = 'unit_tests_public.wikimedia_files(boolean)' THEN RETURN 'U08G' || _id; END IF;
  IF _function = 'unit_tests_public.wikimedia_files_persons(boolean)' THEN RETURN 'U08H' || _id; END IF;
